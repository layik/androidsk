...
//            Log.d("else if: handle shift", "Status : " + String.valueOf(mCapsLock));
    ...
    private void handleCharacter(int primaryCode, int[] keyCodes) {
    	Log.d("layik", "layik>>"+primaryCode);
    	//the reason why we do this at the start is if mPredictionOn the char is added
    	//to the mComposing which goes a different route than commitText
    	String kurdiChar = "";
    	if(converter.get(String.valueOf((char) primaryCode)) != null){
    		  kurdiChar = converter.get(String.valueOf((char) primaryCode));
    	  }else{
    		  kurdiChar = String.valueOf((char) primaryCode);
    	  }
        if (isInputViewShown()) {
